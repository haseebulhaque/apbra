...
APBRA-132 through APBRA-136 will integrate real domain/backend behaviour; full APBRA-129 golden-scenario acceptance requires that integration and is pending. No broad APBRA-27 backend or APBRA-132+ item is implemented here. Power BI Desktop, DAX and RLS runtime are NOT_RUN.
