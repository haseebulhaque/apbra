...
export function KnowledgePanel() {
  ...
  return <section aria-labelledby="knowledge-heading">
    ...
    <p>Independent local evidence preview for the synthetic sales scenario. This does not process your draft or complete the workflow knowledge stage. Design generation is not connected.</p>
